...
def train_wrapper(num):
    ...
    try:
        ...
        print("Error, probabily because one  of this samples don't exist, samples: ", clean_utterance_path,
...
if __name__ == '__main__':
    ...
    parser.add_argument('-r', '--dataset_root_dir', type=str, required=True, help="Config json file")
    ...
    parser.add_argument('-o', '--out_dir', type=str, required=True, help="Directory of output training triplet")
    parser.add_argument('-l', '--librispeech', type=str, required=False, default=False, help="Librispeech format, if true load with librispeech format")
